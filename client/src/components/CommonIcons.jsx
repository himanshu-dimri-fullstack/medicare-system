...
I would like to enquire about your products/services.`;
  ...
  return (
    <div className='z-99 fixed right-0 bottom-10 flex justify-center items-center w-12 bg-white border border-[#ccc] shadow-lg'>
      <ul className='py-3 '>
        <li className='rounded text-xl p-2 hover:bg-[#1c9d36] hover:text-white' onClick={handleWhatsAppRedirect}>
          <FaWhatsapp />
        </li>
        <li className='rounded text-xl p-2 hover:bg-[#1c9d36] hover:text-white' onClick={handleGmailRedirect}>
          <SiGmail />
        </li>
